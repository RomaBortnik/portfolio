export const CLOUDINARY_URL = 'https://res.cloudinary.com/duve6kora/portfolio/';

export const education = [
  {
    id: 'goit',
    name: 'GoIT - start your career in IT',
    degree: 'Full Stack Development',
    period: 'September 2022 - August 2023',
    logo: `${CLOUDINARY_URL}logos/nhksckv8yhxuzwpg3lw7`,
    altText: 'GoIT school logo',
  },
  {
    id: 'nulp',
